...
edges_x = e_data_ll.toDF(["src", "dst", "count"])
edges = edges_x.groupBy("src", "dst").agg({"count" : "sum"})
#edges.show()
...
g.edges.write.parquet("/user/pnda/result/edge")
g.vertices.write.parquet("/user/pnda/result/vertex")
